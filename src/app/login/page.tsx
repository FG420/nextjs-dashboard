            ...
            <div className="flex flex-col items-center justify-center h-screen">
                ...
                <form className="w-2/3 md:w-2/3 lg:w-1/5 bg-gray-700 rounded-lg shadow-lg px-8 pt-8 pb-8 mx-auto">
                    ...
                    <div className="flex items-center justify-between mt-5">
                        <button className="mx-auto font-bold border-2 border-orange-500 rounded-full bg-orange-600 p-2 w-40 text-white hover:text-white hover:bg-orange-500 shadow hover:shadow-gray-400" type="button" onClick={onLogin}>{buttonDisabled ? 'Fill the fields' : 'Login'}</button>
                        <button className="mx-auto font-bold border-2 border-orange-500 rounded-full bg-orange-600 p-2 w-40 text-white hover:text-white hover:bg-orange-500 shadow hover:shadow-gray-400" type="button" ><Link href={'/register'}>Register</Link></button>
                    </div>
                </form>
